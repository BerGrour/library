...
/** @var common\models\AdvancedJournalSearch $searchModel */
?>

<div class="search-title">
    <div class="container-search advanced-search advanced-search-journal">
        <?php $form = ActiveForm::begin([
            ...
            <div class="advanced-search-raw d-flex">
                <span class="advanced-search-label">Журнал</span>

                <?= $form->field($searchModel, 'journal_title')
